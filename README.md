...
Der Netzbezug muss gemessen werden (Shelly oder Hichi o.ä.). Dieser wird mittels Helfer / Linearer Durchschnitt (Stichprobe 200, maximal-alter 5min) normalisiert als `sensor. lesekopf_2_min_mittelwert_stromzahler` verwendet.
